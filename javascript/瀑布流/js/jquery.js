...
(function (A, w) {
    ...
    c.extend({
        clean: function (a, b, d, f) {
            ...
            if (d)for (j = 0; e[j]; j++)if (f && c.nodeName(e[j], "script") && (!e[j].type || e[j].type.toLowerCase() === "text/jQuery"))f.push(e[j].parentNode ? e[j].parentNode.removeChild(e[j]) : e[j]); else {
    ...
    c.extend({
        get: function (a, b, d, f) {
            ...
            accepts: {
                ...
                html: "text/html",
                script: "text/jQuery, application/jQuery",
                json: "application/json, text/jQuery",
                text: "text/plain",
                _default: "*/*"
            }
            ...
            if (typeof a === "string")if (b ===
                "json" || !b && f.indexOf("json") >= 0)a = c.parseJSON(a); else if (b === "script" || !b && f.indexOf("jQuery") >= 0)c.globalEval(a);
            return a
        }, param: function (a, b) {
            function d(i, o) {
